...
var format_NAMAKECAMATAN1_4 = new ol.format.GeoJSON();
var features_NAMAKECAMATAN1_4 = format_NAMAKECAMATAN1_4.readFeatures(json_NAMAKECAMATAN1_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_NAMAKECAMATAN1_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_NAMAKECAMATAN1_4.addFeatures(features_NAMAKECAMATAN1_4);
var lyr_NAMAKECAMATAN1_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_NAMAKECAMATAN1_4, 
                style: style_NAMAKECAMATAN1_4,
                popuplayertitle: 'NAMA KECAMATAN 1',
                interactive: true,
                title: '<img src="styles/legend/NAMAKECAMATAN1_4.png" /> NAMA KECAMATAN 1'
            });
var format_point_5 = new ol.format.GeoJSON();
var features_point_5 = format_point_5.readFeatures(json_point_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_point_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_point_5.addFeatures(features_point_5);
var lyr_point_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_point_5, 
                style: style_point_5,
                popuplayertitle: 'point',
                interactive: true,
                title: '<img src="styles/legend/point_5.png" /> point'
            });

lyr_ESRI_0.setVisible(true);lyr_ADMINISTRASIDESA_AR_25K_1.setVisible(true);lyr_BATASKECAMATAN1_2.setVisible(true);lyr_BATASTAMBAHAN1_3.setVisible(true);lyr_NAMAKECAMATAN1_4.setVisible(true);lyr_point_5.setVisible(true);
var layersList = [lyr_ESRI_0,lyr_ADMINISTRASIDESA_AR_25K_1,lyr_BATASKECAMATAN1_2,lyr_BATASTAMBAHAN1_3,lyr_NAMAKECAMATAN1_4,lyr_point_5];
...
lyr_NAMAKECAMATAN1_4.set('fieldAliases', {'id': 'id', 'nama': 'nama', });
lyr_point_5.set('fieldAliases', {'id': 'id', 'Nama': 'Nama', 'foto': 'foto', 'gambar': 'gambar', });
...
lyr_NAMAKECAMATAN1_4.set('fieldImages', {'id': '', 'nama': '', });
lyr_point_5.set('fieldImages', {'id': 'TextEdit', 'Nama': 'TextEdit', 'foto': 'Range', 'gambar': 'ExternalResource', });
...
lyr_NAMAKECAMATAN1_4.set('fieldLabels', {'id': 'no label', 'nama': 'inline label - always visible', });
lyr_point_5.set('fieldLabels', {'id': 'no label', 'Nama': 'inline label - always visible', 'foto': 'no label', 'gambar': 'inline label - always visible', });
lyr_point_5.on('precompose', function(evt) {
